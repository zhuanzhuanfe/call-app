...
var ZZAppCaller = function (_BaseCaller) {
    ...
    function ZZAppCaller() {
        ...
        return _this = (0, _possibleConstructorReturn3.default)(this, (ZZAppCaller.__proto__ || (0, _getPrototypeOf2.default)(ZZAppCaller)).call(this, _config.dependencies.ZZ_SELLER_SDK, function () {
            _this.ZZSellerAPP = window.ZZSELLER;
            _this.App = new _sdk2.default(_this.ZZSellerAPP);
